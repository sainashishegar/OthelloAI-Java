...
public class OthelloControllerRandomVSGreedy extends OthelloController {
	 ...
	 * with two automatic player, this controller plays the game in silent mode (super.printReport is false).
	 * first player is Random player and the second one is a greedy player
	 */
